...
import { getReviews, getMissions } from "../providers/user.provider.js"
...
export const userMissions = async (req,res,next) =>{
    console.log(req.params.userId);
    res.send(response(status.SUCCESS, await getMissions(req.params.userId, req.query)));
}
